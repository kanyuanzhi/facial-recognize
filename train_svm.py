...
with open("trained_svm_model.clf", 'wb') as f:
    pickle.dump(clf, f)

# Load the test image with unknown faces into a numpy array
# test_image = face_recognition.load_image_file('obama_and_biden.jpg')
test_image = face_recognition.load_image_file('kit_with_rose.jpg')
...
names = clf.predict_proba(test_image_encodings)
print(names)
